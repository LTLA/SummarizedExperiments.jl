@testset "Constructor tests" begin
    @testset "Empty constructor" begin
        ...
        @test size(x.rowdata)[2] == 0
        @test size(x.coldata)[2] == 0
    ...
    rowdata = DataFrame(Features=["Gene1", "Gene2"])
    coldata = DataFrame(Treatment=["normal", "drug1", "drug2"]);
